...
os.mkdir(os.path.join(data_root, data_processed))
data_root_proc = os.path.join(data_root, 'data_processed')
os.mkdir(os.path.join(data_root_proc, 'train')
